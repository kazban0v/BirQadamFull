        ...
        >
          <View style={styles.card}>
            <Text style={styles.description}>
              Обновите ваши основные данные. После сохранения изменения сразу появятся в профиле.
            </Text>
            ...
            />
            <Text style={styles.readOnlyHint}>Email нельзя изменить.</Text>
          </View>
        </ScrollView>

        <View style={styles.footer}>
          <Button title="Сохранить изменения" onPress={handleSave} loading={isLoading} />
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
