        ...
        <View style={styles.overlay}>
          <View style={styles.content}>
            <View style={styles.header}>
              ...
              <Text style={styles.title}>{t('leaveprojectreasonmodal.s_0')}</Text>
            </View>
            ...
            <Text style={styles.description}>
              {t('leaveprojectreasonmodal.s_1')}</Text>

            <View style={styles.warningBox}>
              <Ionicons name="warning-outline" size={18} color={appColors.danger} />
              <Text style={styles.warningText}>
                {t('leaveprojectreasonmodal.s_2')}</Text>
            </View>

            <TextInput
              style={styles.input}
              placeholder={t('leaveprojectreasonmodal.s_3')}
            ...
            <View style={styles.actions}>
              <TouchableOpacity
                ...
                disabled={loading}
              >
                <Text style={styles.secondaryButtonText}>{t('leaveprojectreasonmodal.s_4')}</Text>
              </TouchableOpacity>
              ...
              >
                {loading ? (
                  ...
                  <Text style={styles.primaryButtonText}>{t('leaveprojectreasonmodal.s_5')}</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
