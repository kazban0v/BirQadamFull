...
const DEFAULT_LOADING_TEXT = 'Собираем персональные ориентиры...';
    ...
    <View style={styles.card}>
      ...
      <View style={styles.headerRow}>
        <View style={styles.eyebrowWrap}>
          <Text style={styles.eyebrow}>{activeAction.eyebrow || 'Персональный ориентир'}</Text>
      ...
      {loading ? (
        <View style={styles.loadingState}>
          ...
          <Text style={styles.loadingText}>
            {activeAction.loadingText || DEFAULT_LOADING_TEXT}
          </Text>
        </View>
      ) : (
        <>
