  ...
  return (
    ...
    >
      {imageUrl ? (
        ...
        <ProjectCoverPlaceholder style={[styles.projectImageGrid, styles.projectImagePlaceholder]} size="md" />
      )}
        ...
        <View style={styles.projectInfoGrid}>
          <View style={styles.projectInfoItemGrid}>
            ...
            <Text style={styles.projectInfoTextGrid} numberOfLines={1}>
              {project.city || t('projectcardgrid.s_0')}
            </Text>
          </View>
          <View style={styles.projectInfoItemGrid}>
            <Ionicons name="calendar-outline" size={12} color={appColors.textMuted} />
            <Text style={styles.projectInfoTextGrid} numberOfLines={1}>
              {getDisplayDate()}
            </Text>
          </View>
