              ...
              {canGoBack && (
                ...
                >
                  <Ionicons
                    name="chevron-back"
                    size={16}
                    color={currentStep === 0 ? appColors.textSoft : appColors.primary}
                  />
                  <Text
                    style={[
                ...
                {isProcessingNext ? (
                  ...
                  <>
                    <Text style={styles.tutorialButtonPrimaryText}>
                      {isLastStep ? t('tutorialoverlay.s_1') : t('tutorialoverlay.s_2')}
                    </Text>
                    <Ionicons name="chevron-forward" size={16} color={appColors.white} />
                  </>
                )}
              </TouchableOpacity>
            </View>
