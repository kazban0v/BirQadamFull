...
export const PermissionsStatusScreen: React.FC<PermissionsStatusScreenProps> = ({
  ...
  if (!permissions.notifications.granted) {
    missingPermissions.push({
      ...
      title: t('permissionsstatus.s_0'),
      description:
        t('permissionsstatus.s_1'),
  ...
  if (!permissions.location.granted) {
    missingPermissions.push({
      ...
      title: t('permissionsstatus.s_2'),
      description:
        t('permissionsstatus.s_3'),
  ...
  if (!permissions.network.isConnected) {
    missingPermissions.push({
      ...
      title: t('permissionsstatus.s_4'),
      description:
        t('permissionsstatus.s_5'),
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text style={styles.successTitle}>{t('permissionsstatus.s_6')}</Text>
          <Text style={styles.successDescription}>
            {t('permissionsstatus.s_7')}{'\n'}
            {t('permissionsstatus.s_8')}</Text>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          ...
          <Text style={styles.headerTitle}>{t('permissionsstatus.s_9')}</Text>
        </View>
      ...
      >
        <Animated.View style={[styles.contentContainer, { opacity: fadeAnim }]}>
          ...
          <View style={styles.textSection}>
            <Text style={styles.mainTitle}>{t('permissionsstatus.s_10')}</Text>
            <Text style={styles.mainDescription}>
              {t('permissionsstatus.s_11')}{'\n'}
              {t('permissionsstatus.s_12')}</Text>
          </View>
          ...
          >
            ...
            >
              ...
              <Text style={styles.checkButtonText}>
                {isChecking ? t('permissionsstatus.s_14') : t('permissionsstatus.s_15')}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
