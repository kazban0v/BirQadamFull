...
export const PasswordResetScreen: React.FC<PasswordResetScreenProps> = ({
  ...
  const renderRequestStep = () => (
    <View style={styles.contentWrapper}>
      <View style={styles.iconContainer}>
        <Ionicons name="lock-closed" size={RESPONSIVE.iconSize} color="#10B981" />
      </View>
      ...
      {error && (
        <View style={styles.errorContainer}>
          <Ionicons name="alert-circle" size={RESPONSIVE.errorTextSize + 6} color="#EF4444" />
  ...
  const renderCodeStep = () => (
    <View style={styles.contentWrapper}>
      <View style={styles.iconContainer}>
        <Ionicons name="mail" size={RESPONSIVE.iconSize} color="#10B981" />
      </View>
  ...
  const renderPasswordStep = () => (
    <View style={styles.contentWrapper}>
      <View style={styles.iconContainer}>
        <Ionicons name="key" size={RESPONSIVE.iconSize} color="#10B981" />
      </View>
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            >
              <Ionicons name="arrow-back" size={RESPONSIVE.backButtonSize} color="#1F2937" />
            </TouchableOpacity>
            <Text style={styles.headerTitle}>
              {step === 'request' && 'Сброс пароля'}
