...
from .views.views import project_moderate_approve, project_moderate_reject
...
from .api.topbar import topbar_status
...
urlpatterns = [
    ...
    path('projects/<int:pk>/moderate/approve/', project_moderate_approve, name='project_moderate_approve'),
    path('projects/<int:pk>/moderate/reject/', project_moderate_reject, name='project_moderate_reject'),
    ...
    # API v1 endpoints
    path('api/v1/topbar/status/', topbar_status, name='api_v1_topbar_status'),
