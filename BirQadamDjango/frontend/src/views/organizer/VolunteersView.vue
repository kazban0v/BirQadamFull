...
<template>
  <div class="volunteers-view">
    ...
    <v-dialog 
      v-model="chatDialog" 
      :max-width="$vuetify.display.mobile ? '100%' : '1200'"
      :fullscreen="$vuetify.display.mobile"
      :hide-overlay="!$vuetify.display.mobile"
    ...
    >
      <v-card v-if="chatProjectId && currentProject" class="chat-dialog d-flex flex-column h-100">
        ...
        <div class="chat-container d-flex flex-column flex-md-row flex-grow-1" style="min-height: 500px; height: calc(100vh - 200px);">
          <!-- Список волонтеров -->
          <v-card class="volunteers-sidebar d-flex flex-column" variant="outlined" rounded="0" style="width: 100%; max-width: 100%; border-right: none; border-bottom: 1px solid rgba(0,0,0,0.12);">
          ...
          <div v-if="chat" class="chat-messages-container d-flex flex-column flex-grow-1" style="min-width: 0; min-height: 400px;">
