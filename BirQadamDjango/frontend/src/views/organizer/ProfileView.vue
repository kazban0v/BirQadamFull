...
<template>
  <div class="profile-page">
          ...
          <v-card class="stat-card" elevation="0" rounded="xl">
            ...
            <template v-else>
              ...
              <div class="stat-detail">
                ...
                Активных: <strong>{{ stats.active_projects_count }}</strong>
              </div>
              <div class="stat-detail">
                <v-icon size="16" class="mr-1">mdi-check-all</v-icon>
                Завершённых: <strong>{{ stats.completed_projects_count }}</strong>
              </div>
            </template>
          </v-card>
        </v-col>
          ...
          <v-card class="stat-card" elevation="0" rounded="xl">
            ...
            <template v-else>
              ...
              <div class="stat-detail">
                ...
                Выполнено: <strong>{{ stats.completed_tasks_count }}</strong>
              </div>
              <v-btn
                variant="text"
                color="primary"
        ...
        <v-col cols="12" sm="6" md="4">
          <v-card class="stat-card" elevation="0" rounded="xl">
            ...
            <template v-else>
              ...
              <div class="stat-detail">
                <v-icon size="16" class="mr-1" color="success">mdi-check-circle</v-icon>
                Одобрено: <strong>{{ stats.approved_photos_count }}</strong>
              </div>
              <v-btn
                variant="text"
                color="primary"
    ...
    <!-- Изменение пароля -->
    <v-card class="password-change-card mt-6" elevation="0" rounded="xl">
      <div class="form-header">
    ...
    <v-dialog v-model="passwordDialog" max-width="500" persistent>
      <v-card rounded="xl">
        <v-card-title class="d-flex align-center justify-space-between pa-6">
          <div class="d-flex align-center">
            <v-icon color="primary" size="28" class="mr-3">mdi-lock-reset</v-icon>
            <span class="text-h6 font-weight-bold">Изменение пароля</span>
          </div>
          <v-btn
            icon="mdi-close"
            variant="text"
