...
from core.services.gemini_ai_service import GeminiAIService
from core.services.openai_agent_service import OpenAIAgentService  # Сохраняем для совместимости
