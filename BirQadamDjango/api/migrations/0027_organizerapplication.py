...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0026_message_delivered_at_message_is_delivered_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organizer_application', to='api.user')),
            ],
            options={
