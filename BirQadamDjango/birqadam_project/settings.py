...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'admin_panel.context_processors.admin_topbar',
            ],
        },
    },
]
...
# Celery
CELERY_BROKER_URL = os.getenv('REDIS_URL', 'redis://celery:6379/0')
CELERY_RESULT_BACKEND = os.getenv('REDIS_URL', 'redis://celery:6379/0')
...
# Keep browser referrer behavior valid without leaking full paths cross-origin.
